...
public class GermanColorsTest
{
    ...
    public void testGermanColors() throws Exception
    {
        ...
        assertThat(sourceItem.toString()).isEqualTo("list<term> colors(lexicon) (14,1) (14,21)");
        assertThat(iterator.hasNext()).isTrue();
        ...
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors_var0,0,255,255} (7,4) (7,30)");
        sourceItem = sourceItem.getNext();
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors_var1,0,0,0} (8,4) (8,30)");
        sourceItem = sourceItem.getNext();
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors_var2,0,0,255} (9,4) (9,30)");
        sourceItem = sourceItem.getNext();
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors_var3,255,255,255} (10,4) (10,30)");
        assertThat(iterator.hasNext()).isTrue();
        sourceMarker = iterator.next();
        ///System.out.println(sourceMarker.toString());
