...
public class GermanColorsTest
{
    ...
    public void testGermanColors() throws Exception
    {
        ...
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors.aqua,0,255,255} (7,4) (7,31)");
        sourceItem = sourceItem.getNext();
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors.black,0,0,0} (8,4) (8,31)");
        sourceItem = sourceItem.getNext();
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors.blue,0,0,255} (9,4) (9,31)");
        sourceItem = sourceItem.getNext();
        assertThat(sourceItem).isNotNull();
        //System.out.println(sourceItem.toString());
        assertThat(sourceItem.toString()).isEqualTo("{name=colors.white,255,255,255} (10,4) (10,31)");
        assertThat(iterator.hasNext()).isTrue();
        sourceMarker = iterator.next();
        ///System.out.println(sourceMarker.toString());
