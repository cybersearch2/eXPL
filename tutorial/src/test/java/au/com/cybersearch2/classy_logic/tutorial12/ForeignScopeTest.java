...
import au.com.cybersearch2.classy_logic.tutorial12.ForeignScope;
...
public class ForeignScopeTest
{
    ...
    public void testGermanScope()
    {
        ...
        assertThat(foreignScope.getGermanTotalAmount().toString()).isEqualTo("item_query(total_text=Gesamtkosten + gst: 13.580,24 EUR)");
        /*
