...
public class StampDutyTest
{
    ...
    {
        "{amount?amount<12000,0,0.0,1.0} (3,4) (3,42)",
        "{amount?amount<30000,12000,120.0,2.0} (4,4) (4,42)",
        "{amount?amount<50000,30000,480.0,3.0} (5,4) (5,42)",
        "{amount?amount<100000,50000,1080.0,3.5} (6,4) (6,42)",
        "{amount?amount<200000,100000,2830.0,4.0} (7,4) (7,42)",
        "{amount?amount<250000,200000,6830.0,4.25} (8,4) (8,42)",
        "{amount?amount<300000,250000,8955.0,4.75} (9,4) (9,42)",
        "{amount?amount<500000,300000,11330.0,5.0} (10,4) (10,42)",
        "{amount?amount>500000,500000,21330.0,5.5} (11,4) (11,42)"
    };
