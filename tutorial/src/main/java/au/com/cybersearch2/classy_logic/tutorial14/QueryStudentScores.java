...
*/
    ...
    /**
     * Compiles the query-student-scores.xpl script and runs the "marks" query.<br/>
    ...
    {
        QueryProgram queryProgram = queryProgramParser.loadScript("query-student-scores.xpl");
