...
public class QueryProgram 
{
    ...
    */
	...
	/**
	 * Execute query identified by name in global scope.
	 * @param queryName
	 * @param solutionHandler Handler to process each Solution generated by the query 
	 */
	public Result executeQuery(String queryName, SolutionHandler solutionHandler) 
	{
		return executeQuery(GLOBAL_SCOPE, queryName, solutionHandler);
	}
	...
	{
		return executeQuery(GLOBAL_SCOPE, queryName, new SolutionHandler(){
			@Override
