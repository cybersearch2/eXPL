    ...
    case ASSIGN:
      ...
      case ASSIGN:
        ...
        case IDENTIFIER:
          ...
          if (!qname.getScope().isEmpty() && qname.getScope().equals(context.getContextName().getTemplate()))
