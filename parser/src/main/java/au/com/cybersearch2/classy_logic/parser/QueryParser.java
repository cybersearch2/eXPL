...
/** Root production. */
  ...
  final public Operand AxiomVariable(ParserAssembler parserAssembler) throws ParseException
  {
    ...
    case 81:
      ...
      break;
    case LBRACE:
      axiomList = AxiomList(axiomToken.image, parserAssembler);
      break;
    default:
      jj_la1[37] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Operand Parameter(ParserAssembler parserAssembler) throws ParseException
  {
    ...
    default:
     ...
     if (varType == null)
         {if (true) return operandMap.addOperand(name, expression);}
     if (expression !=  null)
         varType.setProperty(VariableType.EXPRESSION, expression);
